<template>
  ...
  <svg width="120" height="120" viewBox="0 0 250 250" :style="getOctocatStyle">
    <a fill="#FFFFFF" href="https://github.com/NNTin/discord-logo" style="pointer-events:auto">
      <path d="M0,0 L250,250 L250,0 Z"></path>
    </a>
    <g class="octocat">
      <path fill="#000000" d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z" ></path>
      ...
      <g class="octo-glasses" visibility="hidden">
        <svg fill="#000000" width="640" height="480">
         <defs>
