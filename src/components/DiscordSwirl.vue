<template>
  <div class="hello">
    <svg width="500" height="500" xmlns:xlink="http://www.w3.org/1999/xlink" class="discord-logo-container" viewBox="0 0 48 48">
      <defs>
        <g>
          ...
          <mask id="mask-middle-layer">
            ...
            <circle r="42%" cx="50%" cy="50%" fill="#FFFFFF" />
            <circle r="33%" cx="50%" cy="50%" fill="#000000" />
          </mask>
          <mask id="mask-inner-layer">
            <rect width="100%" height="100%" fill="#000000" />
            <circle r="33%" cx="50%" cy="50%" fill="#FFFFFF" />
          </mask>
        </g>
      </defs>
      <g class="discord-logo">
        <use class="discord-original" xlink:href="#discord-logo" />
        <use class="discord-outer-layer" xlink:href="#discord-logo" mask="url(#mask-outer-layer)" />
        <use class="discord-middle-layer" xlink:href="#discord-logo" mask="url(#mask-middle-layer)" />
        <use class="discord-inner-layer" xlink:href="#discord-logo" mask="url(#mask-inner-layer)" />
      </g>
    </svg>
  </div>
</template>
