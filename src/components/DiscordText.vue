<template>
  <div ref="discordTextRootElement">
    <div class="discordtext">
      <DiscordLogo :background="background" :discordEyes="discordEyes" ref="discordLogoFromText" :isRainbow="isRainbow" :animationStyle="animationStyle" :customLink="customLink" :height="height *2" :width="height *2" :discordfill="discordfill" :discordcolor="discordcolor"/>
